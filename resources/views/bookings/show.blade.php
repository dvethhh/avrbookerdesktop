...
<div class="wrapper manage-my-bookings">
    <a href="/bookings">
        <-Back</a> <h2>Manage My Bookings</h2>
            ...
            <div class="wrapper update-booking">
                    ...
                    <Table style="width:40%">
                        <tr>
                            ...
                            <td><select name="avr" id="AVR">
                                    <option value="">{{$booking->avr}}</option>
                            ...
                            <td> <input type="date" name="startdate" id="startdate" min={{ date('Y-m-d') }} value="{{$booking->startdate}}"><br> </td>

                        </tr>
                        <tr>
                            <td> <label for="timestart">Select Start Time:</label> </td>
                            <td> <input type="time" name="timestart" id="timestart" list="limittimeslist" value="{{$booking->timestart}}"></td>
                            <td> <label for="timeend">Select End Time:</label> </td>
                            <td> <input type="time" name="timeend" id="timeend" list="limittimeslist" value="{{$booking->timeend}}"></td>
                        ...
                        <tr>
                            ...
                            <td> <input type="text" name="specialrequests" id="specialrequests" value="{{$booking->specialrequests}}"></td>
                        </tr>
                    </Table>
